          ...
          <CardGroup>
            ...
            <Card className="text-center card-item p-5">
              <Card.Body>
                ...
                <Card.Text>
                  Never lose track of your savings. Get notifications reminding
                  you to save either daily, weekly, monthly. The choice is
                  yours.
                </Card.Text>
              </Card.Body>
            </Card>
            <Card className="text-center card-item p-5">
              <Card.Body>
                ...
                <Card.Text>
                  See your saving performance over time. Get detailed well
                  designed reports along with suggestions for improvements.
                </Card.Text>
              </Card.Body>
            </Card>
          </CardGroup>
        ...
        <CardGroup>
          <Card className="text-center card-item p-5">
            <Card.Body>
              ...
              <Card.Text>
                Create saving groups and save together together with you family,
                friends and colleagues. Save for any goal you wish for.
              </Card.Text>
            </Card.Body>
          </Card>
          <Card className="text-center card-item p-5">
            <Card.Body>
              ...
              <Card.Text>
                Set amounts you wish to save and how you wish to be saving. The
                app will help you track your goals on an easy to use interface.
              </Card.Text>
            </Card.Body>
          </Card>
          <Card className="text-center card-item p-5">
            <Card.Body>
              ...
              <Card.Text>
                See how you compare with the rest of the Chumz community in
                terms of the goals achieved and how much you save
              </Card.Text>
            </Card.Body>
          </Card>
        </CardGroup>
